...
class PromotionDetailController: UIViewController {
    ...
    fileprivate func setupTexts() {
        ...
        if let promotionText = merchant.promotionText {
            promotionLabel.text = promotionText
        } else {
            promotionLabel.text = "Special deal coming for users soon! Stay tuned!"
        }
    }
    ...
    fileprivate func setupHUD() {
        ...
        promotionLabel.anchor(top: acceptedCoinImageView.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 30, paddingLeft: 25, paddingBottom: 0, paddingRight: 25, width: 0, height: 80)
...
extension PromotionDetailController {
    //GOOGLE MAPS
